...
export default function ShuffleAnimation({ onComplete, roundNumber }: ShuffleAnimationProps) {
  ...
  useEffect(() => {
    ...
    shuffleAudioRef.current = new Audio('/sounds/shuffle.mp3');
    pickupAudioRef.current = new Audio('/sounds/pickup.mp3');
    throwAudioRef.current = new Audio('/sounds/throw.mp3');
